...
| `test/` | 55 M | Dossier de qualification IHM (méthodo Edvance) — matrice XLSX + HTML + inputs Pillow | ✅ récent |
...
| Dossier de qualification IHM (méthodo Edvance) | ✅ complet | `test/` : matrice XLSX 49 tests + HTML interactif + 15 images Pillow + scripts run/compare/refs + rapport_qualification.md |
